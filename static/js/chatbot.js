...
var BotHello = ["H how can I help you", "HEY", "HOWDY", "HEYA", "HOLA", "HELLO", "SUP", "KONNICHIWA", "ALOHA"]
...
function answer(x) {
 ...
 /* Questions, Answers and Responses */
                if (question.includes(Goodbye[i])) {
                    ...
                    Else = false; setTimeout(botSays, 600, "\nBot : My name is Intelligent Patient Guider. You can call me PGS Assistant.")
                ...
                /*} else if ( question.includes(HTMLTags7[i]) ) {
                  ...
                  var reactPleasant = ""
                    Else = false;
                      setTimeout(botSays, 600, "\nBot : " + reactHello + ".")
                } else { } }  setTimeout( function() { if (Else === true) {botSays("\n\n**oooooh sorry I have no Idea with that, you can call 0763080423 for more help."); } } , 700);  setTimeout( function() {Else = true; botChat.scrollTop = botChat.scrollHeight;}, 730)
            } function botSays(x) {
